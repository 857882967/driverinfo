...
import com.driverinfo.oldHibernateModel.RoleAuth;
 ...
 * 
 * @see com.driverinfo.model.oldhbm.drivercms.test.RoleAuth
 * @author MyEclipse Persistence Tools
 */
@Transactional
public class RoleAuthService {
	private static final Logger log = LoggerFactory
			.getLogger(RoleAuthService.class);
	// property constants
	...
	public RoleAuth findById(java.lang.Integer id) {
		...
		try {
			RoleAuth instance = (RoleAuth) getCurrentSession().get(
					"com.drivercms.test.RoleAuth", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(RoleAuth instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.drivercms.test.RoleAuth")
	...
	public static RoleAuthService getFromApplicationContext(ApplicationContext ctx) {
		return (RoleAuthService) ctx.getBean("RoleAuthDAO");
	}
}