...
public class Authority implements java.io.Serializable {
	...
	public Authority(String name, String title, String code, String fathercode, String type, String url, String icon,
			String desciption, Integer creatorid, Date createtime, Date updatetime, Integer areaid, Set roleAuths) {
		this.name = name;
		this.title = title;
		this.code = code;
